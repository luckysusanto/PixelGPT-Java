...
#$ -l gpu_type=A40
#$ -l h_rt=02:00:00
#$ -N ErniePixel_Eval_javaBali-baliEval
#$ -j y
#$ -o ErniePixel_Eval_ITT_JavaModel_BaliJavaFurther_BaliEval$JOB_ID.log
...
# --- CONFIGURATION ---
FINETUNED_MODEL_PATH="/projectnb/multilm/lsusanto/PixelGPT/pixelgpt/experiment_output/BaliConstantLR-3Epoch-finetune_transliteration/checkpoint-5064"
EVAL_OUTPUT_DIR="./eval_finetune_itt/baliPretrained/baliEval"

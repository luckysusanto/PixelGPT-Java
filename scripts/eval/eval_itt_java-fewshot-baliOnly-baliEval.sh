...
#$ -l gpu_type=A40
#$ -l h_rt=02:00:00
#$ -N ErniePixel_Eval_BaliOnly
#$ -j y
#$ -o ErniePixel_Eval_ITT_JavaModel_BaliFurther_BaliEval$JOB_ID.log
...
EVAL_OUTPUT_DIR="./eval_finetune_itt/baliPretrained-3epoch/baliEval"

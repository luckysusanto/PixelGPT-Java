...
#$ -N P_JB-Further-B-Llama_Tokenizer
#$ -j y
#$ -o P_JB-Further-B-Llama_Tokenizer-$JOB_ID.log
...
OUTPUT_DIR="/projectnb/multilm/lsusanto/PixelGPT/pixelgpt/_updated_experiment_output/Pretrain_JavaBali-Further_Bali-Llama_Tokenizer"
...
MODEL_PATH="/projectnb/multilm/lsusanto/PixelGPT/pixelgpt/_updated_experiment_output/Pretrain_JavaBali-Llama_Tokenizer"
...
CMD=(
    accelerate launch --main_process_port 29705 --num_processes 4 "${PROJECT_DIR}/${PYTHON_SCRIPT_NAME}"

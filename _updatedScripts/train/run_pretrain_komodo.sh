...
#$ -N P_J-Komodo_Tokenizer
#$ -j y
#$ -o P_J-Komodo_Tokenizer-$JOB_ID.log
...
OUTPUT_DIR="/projectnb/multilm/lsusanto/PixelGPT/pixelgpt/_updated_experiment_output/Pretrain_Java-Komodo_Tokenizer"
PYTHON_SCRIPT_NAME="pretrain_erniepixel.py" 
TOKENIZER_PATH="izzako/javanese-komodo-tokenizer"
...
KOMODO_TEXT_COLUMN="komodo_token_ids"
# --- Training Arguments ---
...
CMD=(
    ...
    --do_train
    --do_eval
    --text_column "${KOMODO_TEXT_COLUMN}"
